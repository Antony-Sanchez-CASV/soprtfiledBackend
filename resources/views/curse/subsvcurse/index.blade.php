                                ...
                                <tbody>
                                    @foreach ($subsvcurses as $subsvcurse)
                                        <tr>
											...
											<td>{{ $subsvcurse->id_scheduleVCurse }}</td>
											<td>{{ $subsvcurse->id_user }}</td>
											<td>{{ $subsvcurse->id_state }}</td>

                                            <td>
                                                <form action="{{ route('subsvcurses.destroy',$subsvcurse->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('subsvcurses.show',$subsvcurse->id) }}"><i class="fa fa-fw fa-eye"></i> Mostrar mas información</a>
